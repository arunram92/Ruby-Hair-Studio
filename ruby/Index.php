...
<div id="services" class="container-fluid text-center">
  <h2>Services</h2>
    <div class="col-sm-3 service service1">
	  <br/>
   ...
   <div class="row">
    <div class="col-sm-12 slideanim">
	   ...
	   <div class="row">
			...
			<div class="col-sm-4 form-group">
			  <input class="form-control" id="name" name="name" placeholder="Mobile Number" type="text" required>
			</div>
			<div class="col-sm-4 form-group">
			  <input class="form-control" id="email" name="email" placeholder="Topic" type="email" required>
			</div>
			<div class="col-sm-2 form-group">
			 </div>
       </div>
...
<footer class="container-fluid text-center">
   <div class="text-center center-block">
              ...
              <a href="#"><i id="social-em" class="fa fa-github-square fa-3x social"></i></a>
